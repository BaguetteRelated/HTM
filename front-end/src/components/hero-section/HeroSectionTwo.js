            ...
            <div className="section-heading-wrap d-flex justify-content-between z-5 position-relative">
              <div className="about-content-left">
                <div className="about-info mb-5">
                  ...
                  WELCOME HERE AND SHARED YOUR TRUTH WITH US
                  </h1>
                  <p className="lead">
                    We are building an place where creator can generate truth with our community
                    and shared ot with other.{' '}
                  </p>
                  <Link href="#">
                    <a className="btn btn-primary mt-4 me-3">Connect your wallet</a>
                  </Link>
                  <Link href="/about-us">
